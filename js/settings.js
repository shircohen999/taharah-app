...
// ═══════════════════════════════════════════════════════
const NOTIF_DEFAULTS = {hpstDays:0, sefirahDays:0, tvilaDays:0, prishaDays:1, nextDays:2};

function SettingsScreen({user, onLogout, palette, setPalette, syncStatus}) {
    ...
    <div className="reveal">
      ...
      <div className="card">
        ...
        <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',padding:'14px 18px'}}>
          <div><div style={{fontSize:14}}>מנהג</div><div style={{fontSize:11,color:'var(--muted)',marginTop:2}}>אשכנז · רמ״א</div></div>
        </div>
      </div>
