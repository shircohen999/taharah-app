...
const _T = {
  he: {
    ...
    phaseLidaBen: 'לידת בן',
    phaseLidaBat: 'לידת בת',
    phaseLidaTwinsBenBen: 'לידת תאומים — בן ובן',
    phaseLidaTwinsBatBat: 'לידת תאומים — בת ובת',
    phaseLidaTwinsBenBat: 'לידת תאומים — בן ובת',
    calLidaSubtypeLabel: 'מין הנולד',
    calLidaBen: 'בן',
    calLidaBat: 'בת',
    calLidaTwinsBenBen: 'תאומים — בן ובן',
    calLidaTwinsBatBat: 'תאומים — בת ובת',
    calLidaTwinsBenBat: 'תאומים — בן ובת',
    calLidaUnknown: '— לא צוין —',
    calBedikaResultLabel: 'תוצאת הבדיקה',
    // Date / time
  ...
  en: {
    ...
    phaseLidaBen: 'Birth of a Boy',
    phaseLidaBat: 'Birth of a Girl',
    phaseLidaTwinsBenBen: 'Twins born — Boy & Boy',
    phaseLidaTwinsBatBat: 'Twins born — Girl & Girl',
    phaseLidaTwinsBenBat: 'Twins born — Boy & Girl',
    calLidaSubtypeLabel: "Baby's sex",
    calLidaBen: 'Boy',
    calLidaBat: 'Girl',
    calLidaTwinsBenBen: 'Twins — Boy & Boy',
    calLidaTwinsBatBat: 'Twins — Girl & Girl',
    calLidaTwinsBenBat: 'Twins — Boy & Girl',
    calLidaUnknown: '— Not specified —',
    calBedikaResultLabel: 'Exam result',
    // Date / time
