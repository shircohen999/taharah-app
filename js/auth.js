...
const LEGAL = {
  terms: {
    ...
    sections: [
      ...
      {h:'מטרת האפליקציה', p:'האפליקציה מיועדת אך ורק כעזר אישי לתיעוד ומעקב. אין לראות בה כלי הלכתי מוסמך, תחליף לשאלת רב או יועצת הלכה מוסמכת, ייעוץ רפואי או כל שירות מקצועי אחר. הוראות הרב או יועצת ההלכה גוברות בכל מקרה של סתירה.'},
